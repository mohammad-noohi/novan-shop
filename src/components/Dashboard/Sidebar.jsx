...
export default function Sidebar({ collapsedLayout, onToggleLayout }) {
  return (
    <motion.aside
      ...
      className={`bg-white max-w-[250px] flex flex-col sticky top-0 border-r border-slate-200 `}>
      {/* sidebar header */}
      ...
      <motion.button onClick={onToggleLayout} className="cursor-pointer absolute top-1/2 left-full -translate-1/2 bg-white p-0.5 border rounded-lg shadow">

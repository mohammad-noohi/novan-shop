      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex items-center justify-between mt-auto">
          <div className="border border-slate-200 dark:border-slate-800 rounded-lg flex  overflow-hidden">
            <button onClick={() => addToCart(product.id)} className="p-1  px-2 cursor-pointer hover:bg-green-100 transition-colors dark:hover:bg-green-900 text-green-600 dark:hover:text-green-100">
